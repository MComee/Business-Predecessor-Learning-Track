...
Local navigation index for the repository root.
...
- `phase-plan.md` — Step-by-step adoption plan for strengthening the repository into a governed, source-grounded, machine-checkable, historically tested business knowledge system.
...
This index lists only files and directories directly visible from the repository root.
